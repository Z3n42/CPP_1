...
class GameConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        can_connect = await self.add_connection()
    ...
    def create_game(self):
        ...
        if created:
            ...
            self.game_state['player_x'] = self.player_id
            player.games += 1
        else:
            if game.player_x is None:
                ...
                self.game_state['player_o'] = self.player_id
                player.games += 1
        game.save()
        player.save()
        return game
    ...
    def winner_select(self, winner):
        ...
        player.wins += 1
        player.save()
        game.player_x_points = self.game_state['scoreLeft']
        game.player_o_points = self.game_state['scoreRight']
        game.save()
    ...
    def add_connection(self):
        if self.room_group_name not in game_states_list:
            game_states_list[self.room_group_name] = {
                ...
                'home_player' : self.player_id,
                'connected_home': True,
                'away_player' : '',
                'connected_away': False
            }
            return True
        elif game_states_list[self.room_group_name]['connected_away'] == False and game_states_list[self.room_group_name]['connected_home'] == True and game_states_list[self.room_group_name]['away_player'] == '' and game_states_list[self.room_group_name]['home_player'] != self.player_id:
            game_states_list[self.room_group_name]['away_player'] = self.player_id
            game_states_list[self.room_group_name]['connected_away'] = True
            return True
        elif game_states_list[self.room_group_name]['connected_home'] == False and game_states_list[self.room_group_name]['connected_away'] == True and game_states_list[self.room_group_name]['home_player'] == self.player_id:
            game_states_list[self.room_group_name]['connected_home'] = True
            return True
        elif game_states_list[self.room_group_name]['connected_away'] == False and game_states_list[self.room_group_name]['connected_home'] == True and game_states_list[self.room_group_name]['away_player'] == self.player_id:
            game_states_list[self.room_group_name]['connected_away'] = True
            return True
        else:
            return False
