...
/*   Updated: 2023/05/07 19:59:21 by ingonzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
	...
	Bureaucrat *ROalloc = NULL;
	Bureaucrat *ROsigner = NULL;
	Bureaucrat *ROunsigner = NULL;
	RobotomyRequestForm *ROform = NULL;
	Bureaucrat *PRalloc = NULL;
	Bureaucrat *PRsigner = NULL;
	Bureaucrat *PRunsigner = NULL;
	PresidentialPardonForm *ROform = NULL;
	...
	try{ 
		...
		RO_alloc = new Bureaucrat("RO_Alloc", 137);
		RO_signer = new Bureaucrat("RO_Signer", 145);
	...
	try{
		...
		RobotomyRequestForm a("A42", "people");
		RobotomyRequestForm b("B42", "42");
	...
	try{ 
		...
		PR_alloc = new Bureaucrat("PR_Alloc", 137);
		PR_signer = new Bureaucrat("PR_Signer", 145);
	...
	try{
		...
		PresidentialPardonForm a("A42", "people");
		PresidentialPardonForm b("B42", "42");
