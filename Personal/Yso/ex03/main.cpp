...
/*   Updated: 2022/06/22 19:54:49 by ingonzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	std::cout << std::endl;
	std::cout << "Nombre =>" << diamondtrap.get_name() << std::endl;
	std::cout << "Hit =>"  << diamondtrap.get_hitpoints() << std::endl;
	std::cout << "Energy =>" << diamondtrap.get_energy_points() << std::endl;
	std::cout << "Attack =>" << diamondtrap.get_attack_damage() << std::endl;
	std::cout << std::endl;
