C-Afalse\C-Atrue\C-Ashell\C-Blocal\C-Bglobal\C-A\C-Astatus\C-Bcommand_execution_time\C-Bbackground_jobs\C-Bdirenv\C-Basdf\C-Bvirtualenv\C-Banaconda\C-Bpyenv\C-Bgoenv\C-Bnodenv\C-Bnvm\C-Bnodeenv\C-Brbenv\C-Brvm\C-Bfvm\C-Bluaenv\C-Bjenv\C-Bplenv\C-Bphpenv\C-Bscalaenv\C-Bhaskell_stack\C-Bkubecontext\C-Bterraform\C-Baws\C-Baws_eb_env\C-Bazure\C-Bgcloud\C-Bgoogle_app_cred\C-Bcontext\C-Bnordvpn\C-Branger\C-Bnnn\C-Bxplr\C-Bvim_shell\C-Bmidnight_commander\C-Bnix_shell\C-Btodo\C-Btimewarrior\C-Btaskwarrior\C-Btime\C-A\C-A\C-A\C-A \C-A-\C-A7\C-A4\C-Atrue\C-A1\C-Afalse\C-Afalse\C-A1\C-Afalse\C-Atrue\C-Ashell\C-Blocal\C-Bglobal\C-A\C-A1\C-A(.bzr|.citc|.git|.hg|.node-version|.python-version|.go-version|.ruby-version|.lua-version|.java-version|.perl-version|.php-version|.tool-version|.shorten_folder_marker|.svn|.terraform|CVS|Cargo.toml|composer.json|go.mod|package.json|stack.yaml)\C-Atruncate_to_unique\C-Afalse\C-Afalse\C-A1\C-Atrue\C-A1\C-Aerr\C-Atrue\C-A1\C-A\C-Aerr\C-Atrue\C-Afalse\C-A2\C-Atrue\C-A2\C-Aok\C-Aok\C-Afalse\C-A3\C-A6\C-A*\C-BOTHER\C-A4\C-Afalse\C-A${P9K_CONTENT:0:24}${${P9K_CONTENT:24}:+..}\C-A4\C-A6\C-A%D{%I:%M:%S %p}\C-Afalse\C-A\C-A4\C-Afalse\C-Atrue\C-Aoff\C-Agit\C-A\C-A2\C-A-1\C-A-1\C-A-1\C-A${$((my_git_formatter(1)))+${my_git_format}}\C-A~\C-Atrue\C-A${$((my_git_formatter(0)))+${my_git_format}}\C-A\C-A-1\C-A3\C-A-1\C-A-1\C-A2\C-A?\C-A-1\C-A2\C-A\C-A3\C-A6\C-A\C-A\C-Afalse\C-Afalse\C-A\C-A3\C-A(gpd|wg|(.*tun)|tailscale)[0-9]*\C-Afalse\C-A4\C-A3'
  local gitstatus_dir=/root/.oh-my-zsh/custom/themes/powerlevel10k/gitstatus
  ...
  local -A _p9k_display_k=(1/left/prompt_char 21 1/right/scalaenv 61 -1/right/background_jobs 27 -1/right/terraform 67 -1/right/nodenv 41 1/right/plenv 57 1/right/nvm 43 1/right/background_jobs 27 -1/right/scalaenv 61 -1/right/plenv 57 1/right/direnv 29 1/right/timewarrior 97 1/right/rvm 49 1/right/midnight_commander 91 -1/right 13 -1/right/aws_eb_env 71 1/right/vim_shell 89 -1/right/google_app_cred 77 1/right/nnn 85 1/right/google_app_cred 77 1/right/asdf 31 -1/left/vcs 19 -1/right/midnight_commander 91 1/right/nordvpn 81 -1/right/asdf 31 1/left/dir 17 -1/right/ranger 83 1/right/rbenv 47 1/right/terraform 67 1/right/nodenv 41 -1/right/rbenv 47 -1/left 11 1/right/virtualenv 33 -1/right/kubecontext 65 1/right_frame 9 1/right 13 1/right/xplr 87 1/right/pyenv 37 -1/right/fvm 51 1/right/nodeenv 45 1/right/goenv 39 -1/right/xplr 87 -1/right/pyenv 37 -1/right/goenv 39 1/right/haskell_stack 63 -1/right/taskwarrior 99 1/right/ranger 83 1/right/jenv 55 1/right/aws 69 -1/right/nix_shell 93 -1/right/jenv 55 empty_line 1 1/right/todo 95 -1/right/nvm 43 -1/right/todo 95 1/right/context 79 -1 5 -1/left/prompt_char 21 1/left 11 -1/right/rvm 49 1/right/azure 73 -1/right_frame 9 -1/gap 15 -1/right/azure 73 -1/right/nordvpn 81 1/right/aws_eb_env 71 1/left/vcs 19 1/right/time 101 -1/right/gcloud 75 -1/right/nnn 85 1/right/kubecontext 65 -1/right/time 101 1/right/anaconda 35 -1/right/status 23 1/right/nix_shell 93 1/left_frame 7 1 5 -1/right/luaenv 53 ruler 3 -1/left_frame 7 -1/right/phpenv 59 1/gap 15 1/right/command_execution_time 25 -1/right/nodeenv 45 1/right/taskwarrior 99 -1/right/timewarrior 97 -1/right/virtualenv 33 -1/left/dir 17 1/right/gcloud 75 1/right/status 23 -1/right/aws 69 -1/right/command_execution_time 25 -1/right/direnv 29 -1/right/context 79 -1/right/haskell_stack 63 1/right/luaenv 53 -1/right/vim_shell 89 1/right/phpenv 59 1/right/fvm 51 -1/right/anaconda 35)
  local -a _p9k__display_v=(empty_line hide ruler hide 1 show 1/left_frame show 1/right_frame show 1/left show 1/right show 1/gap show 1/left/dir show 1/left/vcs show 1/left/prompt_char show 1/right/status show 1/right/command_execution_time show 1/right/background_jobs show 1/right/direnv show 1/right/asdf show 1/right/virtualenv show 1/right/anaconda show 1/right/pyenv show 1/right/goenv show 1/right/nodenv show 1/right/nvm show 1/right/nodeenv show 1/right/rbenv show 1/right/rvm show 1/right/fvm show 1/right/luaenv show 1/right/jenv show 1/right/plenv show 1/right/phpenv show 1/right/scalaenv show 1/right/haskell_stack show 1/right/kubecontext show 1/right/terraform show 1/right/aws show 1/right/aws_eb_env show 1/right/azure show 1/right/gcloud show 1/right/google_app_cred show 1/right/context show 1/right/nordvpn show 1/right/ranger show 1/right/nnn show 1/right/xplr show 1/right/vim_shell show 1/right/midnight_commander show 1/right/nix_shell show 1/right/todo show 1/right/timewarrior show 1/right/taskwarrior show 1/right/time show)
  function p10k() {
    emulate -L zsh -o no_hist_expand -o extended_glob -o no_prompt_bang -o prompt_percent -o no_prompt_subst -o no_aliases -o no_bg_nice -o typeset_silent -o no_rematch_pcre
  (( $+__p9k_trapped )) || { local -i __p9k_trapped; trap : INT; trap "trap ${(q)__p9k_trapint:--} INT" EXIT }
  local -a match reply mbegin mend
